...
public class SqueekeyCleanItem extends Item {
	public SqueekeyCleanItem() {
		...
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				...
				if (entity.getAbilities().instabuild || stack != ItemStack.EMPTY) {
					SqueekeyCleanEntity entityarrow = SqueekeyCleanEntity.shoot(world, entity, world.getRandom(), 0.3f, 5, 1);
