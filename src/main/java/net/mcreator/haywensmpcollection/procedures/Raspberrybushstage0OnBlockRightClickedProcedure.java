...
public class Raspberrybushstage0OnBlockRightClickedProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == Items.BONE_MEAL) {
			if ((world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == HaywensmpcollectionModBlocks.RASPBERRYBUSHSTAGE_0 && Math.random() <= 0.2
						...
						ServerTickEvents.END_SERVER_TICK.register((server) -> {
							...
							if (this.ticks == 5) {
									...
									_level.sendParticles(ParticleTypes.HAPPY_VILLAGER, x, y, z, 5, 1, 1, 1, 1);
								{
									...
									BlockState _bs = HaywensmpcollectionModBlocks.RASPBERRYBUSHSTAGE_1.defaultBlockState();
			...
			if ((world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == HaywensmpcollectionModBlocks.RASPBERRYBUSHSTAGE_1
					&& (entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == Items.BONE_MEAL) {
				if (world instanceof ServerLevel _level)
					_level.sendParticles(ParticleTypes.HAPPY_VILLAGER, x, y, z, 5, 1, 1, 1, 1);
				{
