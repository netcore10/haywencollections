...
public class Raspberrybushstage1OnBlockRightClickedProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == Items.BONE_MEAL) {
			if ((world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == HaywensmpcollectionModBlocks.RASPBERRYBUSHSTAGE_1 && Math.random() <= 0.2
			...
			if ((world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == HaywensmpcollectionModBlocks.RASPBERRYBUSHSTAGE_2
					&& (entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == Items.BONE_MEAL) {
				if (world instanceof ServerLevel _level)
					_level.sendParticles(ParticleTypes.HAPPY_VILLAGER, x, y, z, 5, 1, 1, 1, 1);
				{
