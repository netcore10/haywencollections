...
public class SqueekeyCleanEntity extends AbstractArrow implements ItemSupplier {
	public SqueekeyCleanEntity(EntityType<? extends SqueekeyCleanEntity> type, Level world) {
		super(type, world);
	}

	public SqueekeyCleanEntity(EntityType<? extends SqueekeyCleanEntity> type, double x, double y, double z, Level world) {
		super(type, x, y, z, world);
	}

	public SqueekeyCleanEntity(EntityType<? extends SqueekeyCleanEntity> type, LivingEntity entity, Level world) {
	...
	public static SqueekeyCleanEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		SqueekeyCleanEntity entityarrow = new SqueekeyCleanEntity(HaywensmpcollectionModEntities.SQUEEKEY_CLEAN, entity, world);
	...
	public static SqueekeyCleanEntity shoot(LivingEntity entity, LivingEntity target) {
		SqueekeyCleanEntity entityarrow = new SqueekeyCleanEntity(HaywensmpcollectionModEntities.SQUEEKEY_CLEAN, entity, entity.level());
